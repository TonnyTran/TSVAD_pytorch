...
### Data path
parser.add_argument('--train_list', type=str,   default="/data08/alimeeting/Train_Ali_far/ts_Train.json",     help='The path of the training list')
parser.add_argument('--train_path', type=str,   default="/data08/alimeeting/Train_Ali_far", help='The path of the training data')
parser.add_argument('--eval_list',  type=str,   default="/data08/alimeeting/ts_Eval.json",      help='The path of the evaluation list')
parser.add_argument('--eval_path',  type=str,   default="/data08/alimeeting/Eval_Ali_far", help='The path of the evaluation data')
parser.add_argument('--save_path',  type=str,    default="", help='Path to save the clean list')
parser.add_argument('--musan_path',  type=str,   default="/data08/Others/musan_split", help='The path of the evaluation data')
parser.add_argument('--rir_path',  type=str,   default="/data08/Others/RIRS_NOISES/simulated_rirs", help='The path of the evaluation data')
